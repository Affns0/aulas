 ...
 * @author apola
 */
public class ScreenEvenOdd extends javax.swing.JFrame {

    /**
     * Creates new form ScreenEvenOdd
     */
    public ScreenEvenOdd() {
        initComponents();
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnVar)
                    .addComponent(txtvalue, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnVarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVarActionPerformed
        // TODO add your handling code here:
        int bar = Integer.parseInt(txtvalue.getText());
        if (bar % 2 == 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScreenEvenOdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ScreenEvenOdd().setVisible(true);
            }
        });
    }
